"""
Django settings for frosty_rice_41464 project.
...
ROOT_URLCONF = 'frosty_rice_41464.urls'
...
WSGI_APPLICATION = 'frosty_rice_41464.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_rice_41464 API",
    "DESCRIPTION": "API documentation for frosty_rice_41464 App",
    "VERSION": "v1",
}
